...
Public Class FBPlayoffStreaks
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lblOneColumnDetail.Text = "FOOTBALL ALL-TIME (10+ years) thru 2018 Season"
        ...
        Try
            clsLog.LogEvent("FOOTBALLPlayoffStreaks", Me.Page.AppRelativeVirtualPath.ToString, "", "", strIP, Session("globalState"), Session("globalUser"), strHostName)
        Catch
        End Try

...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <telerik:RadPageLayout runat="server" ID="RadPageLayout21">
                        ...
                        <Rows>
                            ...
                            <telerik:LayoutRow>
                                <Content>
                                    <div style="text-align:center;">
                                    <br />
                                    <h3>ALL TIME FOOTBALL COACHING WINS (thru 9/21/2019)</h3>
                        ...
                        <Rows>
                            <telerik:LayoutRow>
                                <Content>
                                    ...
                                    <asp:HyperLink runat="server" NavigateUrl="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=VRTSU3DSZVXM2&source=url" Target="_blank" ImageUrl="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif"></asp:HyperLink>
                                    <asp:HyperLink runat="server" NavigateUrl="BAFStateInfo.aspx" CssClass="button orange" Target="_self" Visible="true">2019 FALL BASEBALL RECORDS</asp:HyperLink>
                                    <asp:HyperLink runat="server" NavigateUrl="FBCoachingRecords.aspx" CssClass="button orange" Target="_self" Visible="true">FOOTBALL ALL-TIME COACHING W/L</asp:HyperLink>
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 50 RANK() OVER (ORDER BY intWins DESC) As Rank, CAST(intWins AS varchar(5)) + '-' + strCoachesName + ' (' + strLastSchool + ')' AS strDisplayWins, * FROM tblCoachesRecords WHERE strSportGenderKey = 'Football' ORDER BY intWins DESC">
    </asp:SqlDataSource>    
</asp:Content>

<%@ Page Title="Playoff Central : Oklahoma High School Slow Pitch" Language="VB" AutoEventWireup="false" MasterPageFile="MasterPageSoftballWEB.Master" CodeBehind="PlayoffCentralSP.aspx.vb" Inherits="TheSportsEngine2017.PlayoffCentralSP"  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanelMOBILE" runat="server" CssClass="grid_wrapper01">
             <asp:Table runat="server" ID="tblHeaderm" HorizontalAlign="Left" Visible="false" Width="300px">
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Image runat="server" ID="playoffCentralAdM" ImageUrl="~/images/ads/PlayoffCentralSP.png" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:DropDownList runat="server" ID="cboClassm" AutoPostBack="true" Font-Bold="true" Height="42px" Width="90%" Font-Size="X-Large" BackColor="Yellow" style="border-color:lightgray; border-radius:5px;">
                                <asp:ListItem Text="Class 6A STATE" Value="SPSoftball6A"></asp:ListItem>
                                <asp:ListItem Text="Class 5A STATE" Value="SPSoftball5A"></asp:ListItem>
                                <asp:ListItem Text="Class 4A STATE" Value="SPSoftball4A"></asp:ListItem>
                                <asp:ListItem Text="Class 3A STATE" Value="SPSoftball3A"></asp:ListItem>
                                <asp:ListItem Text="Class 2A STATE" Value="SPSoftball2A"></asp:ListItem>
                                <asp:ListItem Text="Class A  STATE" Value="SPSoftballA"></asp:ListItem>
                        </asp:DropDownList>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>           
            <asp:Table runat="server" ID="tblContentM" HorizontalAlign="left" width="100%" Visible ="false">
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                        ...
                        <asp:Label runat="server" ID="Label3" Font-Size="X-Small" Font-Italic="true" Font-Bold="true" ForeColor="Red" Font-Names="Segoe UI,Helvetica,Helvetica Neue,Lucida Grande,Arial,Verdana,Sans-serif;" Text="Click the team below to see season scores and playoff history."></asp:Label>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2">
                ...
                <asp:TableRow runat="server" Width="100%">
                    ...
                    <asp:TableCell ID="cellR1C2m" Font-Bold="true" HorizontalAlign="center" ForeColor="Red" Font-Size="X-Large"><asp:HyperLink runat="server" ID="hlR1C2m" Text="&nbsp;"></asp:HyperLink></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
                    ...
                    <asp:TableCell ID="cellR2C2m" Font-Bold="true" HorizontalAlign="center" ForeColor="Red" Font-Size="X-Large"><asp:HyperLink runat="server" ID="hlR2C2m" Text="&nbsp;"></asp:HyperLink></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanelWEB" runat="server" CssClass="grid_wrapper01">          
            <asp:Table runat="server" ID="tblHeader" HorizontalAlign="Center" Visible="true">
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Image runat="server" ID="playoffCentralAd" ImageUrl="~/images/ads/PlayoffCentralSP.png" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
            ...
            <asp:Table runat="server" ID="tblContent" HorizontalAlign="Center" visible="true">
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:Label runat="server" ID="Label1" Font-Size="Medium" Font-Italic="true" Font-Bold="true" ForeColor="Red" Font-Names="Segoe UI,Helvetica,Helvetica Neue,Lucida Grande,Arial,Verdana,Sans-serif;" Text="Click the team below to see season scores and playoff history."></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OSSAARankingsConnectionString %>" 
        SelectCommand="SELECT * FROM __IWATGSlowPitchScores WHERE SchoolName = @team AND strSportGenderKey = @selectedSport ORDER BY gameDate">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM __viewSlowPitchStateTournamentGamesSort WHERE strState = @state AND (strWinner = @team OR strLoser = @team) AND strSportGenderKey = @sportGenderKey ORDER BY intYear DESC, intSortRound">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />

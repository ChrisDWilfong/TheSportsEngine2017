<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageSoftball.Master" CodeBehind="SBFStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.SBFStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_FPSoftball_StateChampions WHERE strState = @state ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

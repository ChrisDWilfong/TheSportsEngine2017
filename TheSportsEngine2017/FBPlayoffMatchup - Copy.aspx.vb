...
Public Class FBPlayoffMatchup
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim intGlobalYear As Integer = CInt(ConfigurationManager.AppSettings("LastYearOfFootballPlayoffs"))
        ...
        ' TEAM #1...
        RadGridTeam1Season.Columns(1).HeaderText = ConfigurationManager.AppSettings("LastYearOfFootballPlayoffs") & " SEASON : " & Session("globalTeam1")

...
Partial Class StateAcademic
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Me.Title = "Oklahoma Academic State Champions"

        Session("GUID") = ""
        Session("globalSport") = "Academic"
        ...
        intChampionshipCount = SqlHelper.ExecuteScalar(SqlHelper.SQLConnectionIWATG, CommandType.Text, "SELECT COUNT(Id) AS intCount FROM tblAcademicStateChampions WHERE strSchoolKey = '" & Session("globalSchool") & "'")
        ...
        lblOneColumnDetail.Text = "ACADEMIC STATE CHAMPIONSHIPS (" & intChampionshipCount & ")"
        ...
        Page.Title = "Oklahoma Academic State Champions : " & Session("globalSchool")

        Dim strSQL As String = clsStateChampions.GetStateChampionshipsSQL("OK", Session("globalSchool"), True, True, False)
        Dim ds As DataSet
        Dim x As Integer
        ...
        Me.Title = Session("globalSchool") & " Academic State Champions - List of Champions"

        Try
            clsLog.LogEvent("StateAcademic", Me.Page.AppRelativeVirtualPath.ToString, Session("globalSchool"), Session("globalShowAds"), Request.UserHostAddress, Session("globalState"), Session("globalUser"), Request.UserAgent)
        Catch
        End Try

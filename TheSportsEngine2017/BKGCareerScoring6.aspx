<%@ Page Title="Oklahoma High School Girls 6-on-6 Basketball" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketballNoMenu.Master" CodeBehind="BKGCareerScoring6.aspx.vb" Inherits="TheSportsEngine2017.BKGCareerScoring6" %>
            ...
            <telerik:LayoutRow>
                <Columns>
                    <telerik:LayoutColumn Span="12" HiddenXs="true" HiddenSm ="true" SpanMd="12" SpanLg="12" SpanXl="12">
                        ...
                        <asp:Label ID="lblOneColumnDetail0" runat="server" Text="GIRLS 6-on-6 BASKETBALL"></asp:Label></h3>
                    ...
                    <telerik:LayoutColumn Span="12" SpanXs="12" SpanSm="12" HiddenMd="true" HiddenLg="true" HiddenXl="true">
                        ...
                        <asp:Label ID="lblOneColumnDetail" runat="server" Text="GIRLS 6-on-6 BASKETBALL"></asp:Label></h3>
                    </telerik:LayoutColumn>
                </Columns>
            </telerik:LayoutRow>
        </Rows>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT CAST(intPoints AS varchar(10)) + ' - ' + strPlayer + ' (' + strSchool + ' ' + CAST(intGradYear AS varchar(10)) + ') ' + CASE WHEN strNotes IS NULL THEN '' ELSE '<br>' + strNotes END AS strDisplay, * FROM tblBasketballAllTimeScoring WHERE strState = @state AND strGender = 'Girls' AND int5or6 = 6 AND strType = 'CAREER' AND intPoints >= 3000 ORDER BY intPoints DESC">
        <SelectParameters>

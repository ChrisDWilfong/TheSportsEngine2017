...
Partial Class BKBStateSeasonPTSInGame
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lblOneColumnHeader.Text = clsStateChampions.GetPageHeader(Session("globalState"), "HIGH SCHOOL POINTS IN GAME")
        lblOneColumnDetail.Text = "BOYS BASKETBALL - 40 POINT CLUB"

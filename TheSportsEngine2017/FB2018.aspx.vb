...
Public Class FB2018
    ...
    Public viewSchedule As String = "viewFB2018_Schedule"
    Public viewResults As String = "viewFB2018_Schedule"
    Public currentYear As Integer = 2018
    Public currentYearShort As Integer = 19
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            clsLog.LogEvent("FB2018", Me.Page.AppRelativeVirtualPath.ToString, strID, "", Request.UserHostAddress, Session("globalState"), Session("globalUser"), Request.UserAgent)
        Catch
        End Try
    ...
    Public Function GetSQL(strClass As String, intWeekNo As Integer, intDistrictNo As Integer) As String
        If intWeekNo = 1 Then intWeekNo = 0
        Dim strSQL As String = ""
    ...
    Public Function GetCurrentDate(intCurrentWeekNo As Integer) As String
        ...
        Select Case intCurrentWeekNo
            Case 0
                strCurrentDate = "Aug 24th"
            Case 1
                strCurrentDate = "Aug 31st"
            Case 2
                strCurrentDate = "Sept 7th"
            Case 3
                strCurrentDate = "Sept 14th"
            Case 4
                strCurrentDate = "Sept 21th"
            Case 5
                strCurrentDate = "Sept 28th"
            Case 6
                strCurrentDate = "Oct 5th"
            Case 7
                strCurrentDate = "Oct 12th"
            Case 8
                strCurrentDate = "Oct 19th"
            Case 9
                strCurrentDate = "Oct 26th"
            Case 10
                strCurrentDate = "Nov 2nd"
            Case 11
                strCurrentDate = "Nov 9th"
            Case 12
                strCurrentDate = "Nov 16th"
            Case 13
                strCurrentDate = "Nov 23rd"
            Case 14
                strCurrentDate = "Nov 30th"
            Case 15
                strCurrentDate = "Dec 7th"
        End Select
    ...
    Public Function GetView(strWeek As String, intCurrentWeekNo As Integer, ByRef intSelectedWeekNo As Integer, ByRef strSelectedDate As String) As String
        ...
        Select Case strWeek
            ...
            Case "WK0"
                strSelectedDate = GetCurrentDate(0) & ", " & currentYear
                If intCurrentWeekNo = 0 Then
                    strResults = viewSchedule
                    lblScheduleHeader.Text = "WEEK 0 (" & strSelectedDate & ") SCHEDULE"
                Else
                    strResults = viewResults
                    lblScheduleHeader.Text = "WEEK 0 (" & strSelectedDate & ") RESULTS"
                End If
                intSelectedWeekNo = 0

            Case "WK1"
                strSelectedDate = GetCurrentDate(1) & ", " & currentYear
                If intCurrentWeekNo <= 1 And intCurrentWeekNo >= 0 Then
                    strResults = viewSchedule

<%@ Page Title="2018 Oklahoma High School Fall Baseball RPI" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBaseballNOAJAX.Master" CodeBehind="RPIBaseballFall.aspx.vb" Inherits="TheSportsEngine2017.RPIBaseballFall" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Fall Baseball RPI" />
    <meta name="twitter:description" content="2019 Oklahoma High School Fall Baseball Calculations" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 strDisplay + ' (' + CAST(SOSRank AS varchar(10)) + ')' AS strDisplayFinalRPI FROM RPI WHERE Class = @class AND Sport = 'BaseballFall' AND DateEnd = '2019-09-13' ORDER BY RPIRank">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 strDisplaySOS + ' (' + CAST(RPIRank AS varchar(10)) + ')' AS strDisplayFinalSOS FROM RPI WHERE Class = @class AND Sport = 'BaseballFall' AND DateEnd = '2019-09-13' ORDER BY SOSRank">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="class" DefaultValue="A" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource> 

<%@ Page Title="2018 Oklahoma High School Baseball Games" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBaseball.Master" CodeBehind="BAOD.aspx.vb" Inherits="TheSportsEngine2017.BAOD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:DropDownList ID="RadDropDownListClass" runat="server" AutoPostBack="True"
                        ...
                        <asp:ListItem Text="Class 6A" Value="Baseball6A"></asp:ListItem>
                        <asp:ListItem Text="Class 5A" Value="Baseball5A"></asp:ListItem>
                        <asp:ListItem Text="Class 4A" Value="Baseball4A"></asp:ListItem>
                        <asp:ListItem Text="Class 3A" Value="Baseball3A"></asp:ListItem>
                        <asp:ListItem Text="Class 2A" Value="Baseball2A"></asp:ListItem>
                        <asp:ListItem Text="Class A" Value="BaseballA"></asp:ListItem>
                        <asp:ListItem Text="Class B" Value="BaseballB"></asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OSSAARankingsConnectionString %>" 
        SelectCommand="SELECT *, SchoolName + ' (' + CAST(W AS varchar) + '-' + CAST(L AS varchar) + ')' AS schoolWL, CAST(W AS varchar) + '-' + CAST(L AS varchar) AS WL FROM viewStatsBaseballRPGSUM WHERE Games >= 10 AND sportID = @sportID">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="sportID" DefaultValue="NONE" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource>    

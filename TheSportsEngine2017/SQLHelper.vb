...
Public NotInheritable Class SqlHelper
    ...
    Public Shared IsLocal As Integer
    Public Shared IsDeveloping As Integer
    Public Shared strConnection As String
    Public Shared IsAccessConnection As Boolean

    Private Shared gdbServerUsername As String
    Private Shared gdbServerPassword As String
    Private Shared gdbName As String

    Private Shared gdbConnectionFORUM As String
    Private Shared gdbConnectionIWATG As String
    Private Shared gdbConnectionTSE As String
    Private Shared gdbConnectionOSSAARankings As String

    Public Shared Function RedirectToLogin(ByVal strSource As String) As String
        Return "Login.aspx?from=" & strSource
    End Function
...
#Region "Servers"
    ...
    Public Shared ReadOnly Property SQLConnectionFORUM() As String
        Get
            If gdbConnectionFORUM = "" Then
                gdbConnectionFORUM = System.Configuration.ConfigurationManager.ConnectionStrings("FORUMConnectionString").ToString
            End If
            Return gdbConnectionFORUM
        End Get
    End Property

    Public Shared ReadOnly Property SQLConnectionIWATG() As String
        Get
            If gdbConnectionIWATG = "" Then
                gdbConnectionIWATG = System.Configuration.ConfigurationManager.ConnectionStrings("IWATGConnectionString").ToString
            End If
            Return gdbConnectionIWATG
        End Get
    End Property

    Public Shared ReadOnly Property SQLConnectionTSE() As String
        Get
            If gdbConnectionTSE = "" Then
                gdbConnectionTSE = System.Configuration.ConfigurationManager.ConnectionStrings("TSEConnectionString").ToString
            End If
            Return gdbConnectionTSE
        End Get
    End Property

    Public Shared ReadOnly Property SQLConnectionOSSAARankings() As String
        Get
            If gdbConnectionOSSAARankings = "" Then
                gdbConnectionOSSAARankings = System.Configuration.ConfigurationManager.ConnectionStrings("OSSAARankingsConnectionString").ToString
            End If
            Return gdbConnectionOSSAARankings
        End Get
    End Property

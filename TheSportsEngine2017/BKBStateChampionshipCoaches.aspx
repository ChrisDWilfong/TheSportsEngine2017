<%@ Page Title="Oklahoma High School Basketball Boys State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKBStateChampionshipCoaches.aspx.vb" Inherits="TheSportsEngine2017.BKBStateChampionshipCoaches" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT strCoach, COUNT(strCoach) AS intChampionships, CAST(COUNT(strCoach) AS varchar(10)) + ' : ' + strCoach AS strDisplay, RANK() OVER (ORDER BY COUNT(strCoach) DESC) AS intRank FROM IWATGview_Basketball_StateChampions WHERE (strState = @state) AND (strSportGenderKey = 'BasketballBoys') GROUP BY strCoach ORDER BY intChampionships DESC, strCoach">
        <SelectParameters>

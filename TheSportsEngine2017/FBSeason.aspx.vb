...
Public Class FBSeason
    Inherits RadAjaxPage

    Public viewSchedule As String = "viewFBFlashback_Schedule_CurrentYear"
    Public viewResults As String = "viewFBFlashback_Results_CurrentYear"
    Public currentYear As Integer = 2018
    Public currentYearShort As Integer = 18
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        intCurrentWeekNo = ConfigurationManager.AppSettings("CurrentSeasonWK")
        ...
        Try
            clsLog.LogEvent("FB2018", Me.Page.AppRelativeVirtualPath.ToString, "", "", Request.UserHostAddress, Session("globalState"), Session("globalUser"), Request.UserAgent)
        Catch
        End Try

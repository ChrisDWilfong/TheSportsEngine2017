	<%@ Page Title="2019-20 Oklahoma High School Basketball Games" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketballNOAJAX.Master" CodeBehind="BKOD.aspx.vb" Inherits="TheSportsEngine2017.BKOD" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="2019-20 Oklahoma High School Basketball Team Offense/Defense" />
	<meta name="twitter:description" content="IWasAtTheGame.com" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <asp:Panel ID="PanelBKOD" runat="server" CssClass="grid_wrapper">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" CssClass="grid_wrapper">
        <asp:Table runat="server" ID="tblBKOD">
            <asp:TableRow>
                <asp:TableCell>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OSSAARankingsConnectionString %>" 
        SelectCommand="SELECT *, CAST(W AS varchar) + '-' + CAST(L AS varchar) AS WL FROM viewStatsBasketballPPGSUM20 WHERE Games >= 22 AND sportID = @sportID">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="sportID" DefaultValue="BasketballBoys6A" />
        </SelectParameters>  
    </asp:SqlDataSource>    

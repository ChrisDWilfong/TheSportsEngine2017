<%@ Page Title="Oklahoma High School Boys Basketball Game Scoring 2017-2018" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKBGameScoring2018.aspx.vb" Inherits="TheSportsEngine2017.BKBGameScoring2018" %>
            ...
            <telerik:LayoutRow>
                <Columns>
                    <telerik:LayoutColumn Span="12" HiddenXs="true" HiddenSm ="true" SpanMd="12" SpanLg="12" SpanXl="12">
                        <h3><asp:Label ID="lblOneColumnHeader0" runat="server" Text="OKLAHOMA HIGH SCHOOL 2017-18 40 POINT CLUB" Font-Bold="true"></asp:Label><br />
                        <asp:Label ID="lblOneColumnDetail0" runat="server" Text="BOYS BASKETBALL - #OK40PointClub"></asp:Label></h3>
                    </telerik:LayoutColumn>
                    <telerik:LayoutColumn Span="12" SpanXs="12" SpanSm="12" HiddenMd="true" HiddenLg="true" HiddenXl="true">
                        <h3><asp:Label ID="lblOneColumnHeader" runat="server" Text="OKLAHOMA HIGH SCHOOL 2017-18 40 POINT CLUB" Font-Bold="true"></asp:Label><br />
                        <asp:Label ID="lblOneColumnDetail" runat="server" Text="BOYS BASKETBALL - #OK40PointClub"></asp:Label></h3>
                    </telerik:LayoutColumn>
                </Columns>
            </telerik:LayoutRow>
        </Rows>

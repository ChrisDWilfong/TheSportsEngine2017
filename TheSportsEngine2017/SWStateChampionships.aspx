<%@ Page Title="Oklahoma High School Swimming State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageSwimming.Master" CodeBehind="SWStateChampionships.aspx.vb" Inherits="TheSportsEngine2017.SWStateChampionships" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Swimming State Champions" />
    <meta name="twitter:description" content="ALL-TIME High School Swimming State Champions (since 1937)" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                ...
                <asp:TableCell>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowSorting="True" AutoGenerateColumns="False" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" TableLayout="Fixed" AllowSorting="false" AllowFilteringByColumn="false" DataKeyNames="Id" NoMasterRecordsText="Make selection above...">
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="strDisplayResultsGender" HeaderAbbr="Team" UniqueName="strDisplayResultsGender" HeaderText="STATE CHAMPIONS" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Swimming_StateChampions WHERE strState = @state AND intYear = @selectedYear ORDER BY strSportGenderKey DESC, strClass DESC">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT intYear, CAST(intYear AS varchar) AS strYear FROM IWATGview_Swimming_StateChampions WHERE strState = @state ORDER BY intYear DESC">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />
        </SelectParameters>    
    </asp:SqlDataSource>   

<%@ Page Title="Playoff Central : Oklahoma High School Slow Pitch Softball" Language="VB" AutoEventWireup="false" MasterPageFile="MasterPageSoftballPS.Master" CodeBehind="PlayoffCentralSPS.aspx.vb" Inherits="TheSportsEngine2017.PlayoffCentralSPS"  %>
            ...
            <asp:Table runat="server" ID="tblContent" HorizontalAlign="Center" visible="true">
                <asp:TableRow>
                    <asp:TableCell>
                        ...
                        <asp:HyperLink runat="server" Text="SHOW ME THE BRACKET!" ID="hlShowBracket" NavigateUrl="~/PlayoffCentralSPS.aspx" Font-Bold="true" Font-Size="XX-Large"></asp:HyperLink>   
                        <asp:Table runat="server" ID="tblPlayoffCentralSPS" Width="1080px" BorderColor="Black" BorderWidth="1">
                                        <asp:TableRow>

...
Partial Class BAStateRunnersUpCount
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            SqlDataSource1.SelectCommand = "SELECT * FROM IWATGview_BaseballChampionshipGamesLosses_ALL WHERE strState = @state ORDER BY intLosses DESC, strTeam"
        End If

<%@ Page Title="Oklahomans in the Major Leagues" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBaseballMLB.Master" CodeBehind="BAMLB.aspx.vb" Inherits="TheSportsEngine2017.BAMLB" %>
            ...
            <telerik:LayoutRow>
                <Columns>
                    <telerik:LayoutColumn Span="12" HiddenXs="true" HiddenSm ="true" SpanMd="12" SpanLg="12" SpanXl="12">
                        ...
                        <asp:Label ID="lblOneColumnDetail0" runat="server" Text="(as of)"></asp:Label></h3>
                    ...
                    <telerik:LayoutColumn Span="12" SpanXs="12" SpanSm="12" HiddenMd="true" HiddenLg="true" HiddenXl="true">
                        ...
                        <asp:Label ID="lblOneColumnDetail" runat="server" Text="(as of)"></asp:Label></h3>

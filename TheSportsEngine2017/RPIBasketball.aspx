<%@ Page Title="2018-19 Oklahoma High School Basketball RPI" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketballNOAJAX.Master" CodeBehind="RPIBasketball.aspx.vb" Inherits="TheSportsEngine2017.RPIBasketball" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <telerik:LayoutRow>
                <Columns>
                    ...
                    <telerik:LayoutColumn Span="2" SpanXl="2" SpanLg="2" SpanMd="12" SpanSm="12" SpanXs="12">
                        <br />
                        <asp:HyperLink runat="server" NavigateUrl="BKOD.aspx" CssClass="button orange" Target="_self" Visible="true">Basketball OFF/DEF</asp:HyperLink>
                        <br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 strDisplay + ' (' + CAST(SOSRank AS varchar(10)) + ')' AS strDisplayFinalRPI, (Sport + Class) AS SportGenderKey FROM RPI WHERE (Sport + Class) = @class AND DateEnd = '2018-12-31' ORDER BY RPIRank">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 strDisplaySOS + ' (' + CAST(RPIRank AS varchar(10)) + ')' AS strDisplayFinalSOS, (Sport + Class) AS SportGenderKey FROM RPI WHERE (Sport + Class) = @class AND DateEnd = '2018-12-31' ORDER BY SOSRank">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="class" DefaultValue="A" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource> 

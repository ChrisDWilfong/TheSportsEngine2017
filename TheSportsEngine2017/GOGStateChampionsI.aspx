<%@ Page Title="Oklahoma High School Golf Girls State Champions" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageGolf.Master" CodeBehind="GOGStateChampionsI.aspx.vb" Inherits="TheSportsEngine2017.GOGStateChampionsI" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" CssClass="grid_wrapper">
        <asp:Table runat="server" ID="tblGOBStateTourneyScores">
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowPaging="false" >
                        <MasterTableView DataSourceID="SqlDataSource1" TableLayout="Fixed" AllowSorting="false" AllowFilteringByColumn="false" NoMasterRecordsText="Make selection above...">
                            <Columns>
                                <telerik:GridBoundColumn DataField="strDisplay" HeaderAbbr="Team" UniqueName="strDisplay" HeaderText="GOLF GIRLS STATE CHAMPIONS" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Golf_StateChampionsIndividuals WHERE strSportGenderKey = 'GolfGirls' AND strState = @state AND strSchool = @selectedSchool ORDER BY intYear DESC, intSortClass">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strSchool FROM IWATGview_Golf_StateChampionsIndividuals WHERE strSportGenderKey = 'GolfGirls' AND strState = @state ORDER BY strSchool">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />
        </SelectParameters>    
    </asp:SqlDataSource>    

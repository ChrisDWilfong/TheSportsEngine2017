...
Public Class BKGGameScoringAT
    Inherits RadAjaxPage
    Dim intValue As Long

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        lblOneColumnHeader.Text = clsStateChampions.GetPageHeader(Session("globalState"), "<strong>HIGH SCHOOL " & Session("globalYear") & " 45+ GAME SCORING</strong>")
        lblOneColumnHeader0.Text = lblOneColumnHeader.Text

        Me.Title = "Most points scored in Oklahoma High School Girls Basketball Game"

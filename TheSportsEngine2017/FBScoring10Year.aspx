<%@ Page Title="Oklahoma High School Football Games" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootballNOAJAX.Master" CodeBehind="FBScoring10Year.aspx.vb" Inherits="TheSportsEngine2017.FBScoring10Year" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Football WL Records Past 10 Seasons" />
    <meta name="twitter:description" content="2019 Oklahoma High School Football W-L Records in the Past 10 Seasons" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_FootballOffense_10YearsPPG WHERE strState = @state AND lastClass = @cboClass AND Not lastClass Is Null AND TotalGames >= 50 ORDER BY PPG DESC">
        <SelectParameters>

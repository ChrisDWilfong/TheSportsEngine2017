<%@ Page Title="Oklahoma High School Gymnastics State Champions" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageGymnastics.Master" CodeBehind="GYMStateChampionships.aspx.vb" Inherits="TheSportsEngine2017.GYMStateChampionships" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Gymnastics_StateChampions WHERE strState = @state AND intYear = @selectedYear ORDER BY strSportGenderKey DESC, strClass">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT intYear, CAST(intYear AS varchar) AS strYear FROM IWATGview_Gymnastics_StateChampions WHERE strState = @state ORDER BY intYear DESC">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />
        </SelectParameters>    
    </asp:SqlDataSource>    

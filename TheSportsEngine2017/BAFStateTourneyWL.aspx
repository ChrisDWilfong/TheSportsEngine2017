<%@ Page Title="Oklahoma High School Basketball Boys State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPage2017.Master" CodeBehind="BAFStateTourneyWL.aspx.vb" Inherits="TheSportsEngine2017.BAFStateTourneyWL" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 *, W AS intWins, CAST(W AS varchar) + ' - ' + strTeam + ' (' + CAST(W as varchar) + '-' + CAST(L as varchar) + ')' AS strDisplay FROM IWATGview_BaseballFall_StateTournamentWLRecords ORDER BY W DESC, strTeam">
        <SelectParameters>

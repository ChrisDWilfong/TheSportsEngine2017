...
Partial Class GYMGStateChampionshipCount
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Session("globalSport") = "GymnasticsGirls"

        lblOneColumnDetail.Text = "GIRLS GYMNASTICS" & clsStateChampions.GetSinceFirstYear(Session("globalState"), Session("globalSport"))

<%@ Page Title="Oklahoma High School Boys Track State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageVolleyball.Master" CodeBehind="VBBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.VBBStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Volleyball_StateChampions WHERE strState = @state AND strSportGenderKey = 'VolleyballBoys'  ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

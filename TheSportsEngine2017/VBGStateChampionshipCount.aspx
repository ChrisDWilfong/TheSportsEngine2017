<%@ Page Title="Oklahoma High School Boys Track State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageVolleyball.Master" CodeBehind="VBGStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.VBGStateChampionshipCount" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:description" content="Oklahoma High School Volleyball State Championship COUNT (since 1955)" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Volleyball_StateChampions WHERE strState = @state AND strSportGenderKey = 'Volleyball' ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

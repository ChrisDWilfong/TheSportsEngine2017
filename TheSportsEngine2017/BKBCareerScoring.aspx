<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketballNoMenu.Master" CodeBehind="BKBCareerScoring.aspx.vb" Inherits="TheSportsEngine2017.BKBCareerScoring" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 CAST(intPoints AS varchar(10)) + ' - ' + strPlayer + ' (' + strSchool + ' ' + CAST(intGradYear AS varchar(10)) + ') ' + CASE WHEN strNotes IS NULL THEN '' ELSE '<br>' + strNotes END AS strDisplay, * FROM tblBasketballAllTimeScoring WHERE strGender = 'Boys' AND strType = 'CAREER' AND strState = @state ORDER BY intPoints DESC">
        <SelectParameters>

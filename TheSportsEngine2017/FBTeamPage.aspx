    <%@ Page Title="Oklahoma High School Football Team Page" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootballNOAJAX.Master" CodeBehind="FBTeamPage.aspx.vb" Inherits="TheSportsEngine2017.FBTeamPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                ...
                <Columns>
                    ...
                    <telerik:LayoutColumn Span="6" SpanXl="6" SpanLg="6" SpanMd="12" SpanSm="12" SpanXs="12">
                        <asp:Table runat="server" ID="tblBKBStateTourneyScores">
                            <asp:TableRow>
                                <asp:TableCell HorizontalAlign="center"><asp:HyperLink runat="server" ID="hlSchoolAd1" Visible="false" Target="_blank"></asp:HyperLink></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell>
                                    ...
                                    <asp:DropDownList ID="RadDropDownListYear" runat="server" DataSourceID="SqlDataSourceYears" DataTextField="intYear" DataValueField="intYear" 
                                        AutoPostBack="True" DefaultMessage="Select Year..." DropDownHeight="225px" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Football_Games WHERE strState = @state AND strSchool = @selectedSchool AND intYear = @selectedYear ORDER BY intSort, strInfo, Id">
        <SelectParameters>
            ...
            <asp:ControlParameter Name="selectedYear" ControlID="RadDropDownListYear" PropertyName="SelectedValue" DefaultValue="2017" />
        </SelectParameters>    
    </asp:SqlDataSource>    
    ...
    <asp:SqlDataSource ID="SqlDataSourceYears" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT intYear FROM IWATGview_Football_Games WHERE intYear <= 2019 AND strState = @state AND strSchool = @school ORDER BY intYear DESC">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />

...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <telerik:RadPageLayout runat="server" ID="RadPageLayout2">  
        <Rows>
            <telerik:LayoutRow>
                <Columns>
                    <telerik:CompositeLayoutColumn Span="3" SpanSm="12" SpanXs="12" SpanMd="12" SpanLg="3" SpanXl="3">
                        <Rows>
                            <telerik:LayoutRow>
                                <Content>
                    ...
                    <telerik:CompositeLayoutColumn Span="6" SpanSm="12" SpanXs="12" SpanMd="6" SpanLg="6" SpanXl="6">
                        <Rows>
                            ...
                            <telerik:LayoutRow>
                                <Content>&nbsp;&nbsp;<asp:HyperLink runat="server" Text="ALL-TIME FOOTBALL SEASON PASSING YARDS" NavigateUrl="/docs/ok/2017-All-Time_SeasonFootballRecords_Passing.pdf" Target="_blank" CssClass="button orange"></asp:HyperLink></Content>
                            </telerik:LayoutRow>
                            <telerik:LayoutRow>
                                <Content>&nbsp;&nbsp;<asp:HyperLink runat="server" Text="ALL-TIME FOOTBALL SEASON RUSHING YARDS" NavigateUrl="/docs/ok/2017-All-Time_SeasonFootballRecords_Rushing.pdf" Target="_blank" CssClass="button orange"></asp:HyperLink></Content>
                            </telerik:LayoutRow>
                            <telerik:LayoutRow>
                                <Content>&nbsp;&nbsp;<asp:HyperLink runat="server" Text="ALL-TIME FOOTBALL SEASON RECEIVING AND INTERCEPTIONS" NavigateUrl="/docs/ok/2017-All-Time_SeasonFootballRecords_RecAndInts.pdf" Target="_blank" CssClass="button orange"></asp:HyperLink></Content>
                            </telerik:LayoutRow>

<%@ Page Title="2018 Oklahoma High School Fall Baseball Games" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBaseballNOAJAX.Master" CodeBehind="BAFOD.aspx.vb" Inherits="TheSportsEngine2017.BAFOD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:DropDownList ID="RadDropDownListClass" runat="server" AutoPostBack="True"
                        ...
                        <asp:ListItem Text="Class A" Value="BaseballFallA"></asp:ListItem>
                        <asp:ListItem Text="Class B" Value="BaseballFallB"></asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OSSAARankingsConnectionString %>" 
        SelectCommand="SELECT *, SchoolName + ' (' + CAST(W AS varchar) + '-' + CAST(L AS varchar) + ')' AS schoolWL, CAST(W AS varchar) + '-' + CAST(L AS varchar) AS WL FROM viewStatsBaseballFallRPGSUM WHERE Games >= 8 AND sportID = @sportID ORDER BY ppgOff DESC">
        <SelectParameters>

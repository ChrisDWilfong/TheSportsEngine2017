<%@ Page Title="Oklahoma High School Boys Lacrosse State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageLacrosse.Master" CodeBehind="LABStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.LABStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Lacrosse_StateChampions WHERE strState = @state AND strSportGenderKey = 'LacrosseBoys' AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

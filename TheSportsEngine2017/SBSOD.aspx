<%@ Page Title="2019 Oklahoma High School Slow Pitch Softball" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageSoftballNOAJAX.Master" CodeBehind="SBSOD.aspx.vb" Inherits="TheSportsEngine2017.SBSOD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OSSAARankingsConnectionString %>" 
        SelectCommand="SELECT *, SchoolName + ' (' + CAST(W AS varchar) + '-' + CAST(L AS varchar) + ')' AS schoolWL, CAST(W AS varchar) + '-' + CAST(L AS varchar) AS WL FROM viewStatsSlowPitchRPGSUM WHERE Games >= 15 AND sportID = @sportID ORDER BY ppgOff DESC">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="sportID" DefaultValue="SPSoftball6A" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource>    

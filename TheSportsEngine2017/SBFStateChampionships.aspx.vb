...
Partial Class SBFStateChampionships
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                Try
                    ...
                    RadDropDownListYear.SelectedValue = CInt(ConfigurationManager.AppSettings("CurrentYear"))
        ...
        Try
            clsLog.LogEvent("SOFTBALLFP", Me.Page.AppRelativeVirtualPath.ToString, RadDropDownListYear.SelectedValue, "", Request.UserHostAddress, Session("globalState"), Session("globalUser"), Request.UserAgent)
        Catch
        End Try
    End Sub

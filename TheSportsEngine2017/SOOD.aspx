<%@ Page Title="2018 Oklahoma High School Soccer Games" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageSoccer.Master" CodeBehind="SOOD.aspx.vb" Inherits="TheSportsEngine2017.SOOD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:DropDownList ID="RadDropDownListClass" runat="server" AutoPostBack="True"
                        ...
                        <asp:ListItem Text="6A Boys" Value="SoccerBoys6A"></asp:ListItem>
                        <asp:ListItem Text="6A Girls" Value="SoccerGirls6A"></asp:ListItem>
                        <asp:ListItem Text="5A Boys" Value="SoccerBoys5A"></asp:ListItem>
                        <asp:ListItem Text="5A Girls" Value="SoccerGirls5A"></asp:ListItem>
                        <asp:ListItem Text="4A Boys" Value="SoccerBoys4A"></asp:ListItem>
                        <asp:ListItem Text="4A Girls" Value="SoccerGirls4A"></asp:ListItem>
                    </asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OSSAARankingsConnectionString %>" 
        SelectCommand="SELECT *, CAST(W AS varchar) + '-' + CAST(L AS varchar) AS WL FROM viewStatsSoccerGPGSUM WHERE Games >= 5 AND sportID = @sportID">
        <SelectParameters>

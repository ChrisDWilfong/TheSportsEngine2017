<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKBUndefeated.aspx.vb" Inherits="TheSportsEngine2017.BKBUndefeated" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Boys Basketball All-Time Undefeated Teams" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Basketball_Undefeated WHERE strSportGenderKey = 'BasketballBoys' AND strState = @state ORDER BY intYear DESC">
        <SelectParameters>

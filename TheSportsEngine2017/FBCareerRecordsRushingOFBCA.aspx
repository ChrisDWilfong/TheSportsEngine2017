<%@ Page Title="Oklahoma High School Football All-Time Career Rushing Yards" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBCareerRecordsRushingOFBCA.aspx.vb" Inherits="TheSportsEngine2017.FBCareerRecordsRushingOFBCA" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Football State Rushing Records" />
    <meta name="twitter:description" content="ALL-TIME High School Football State Rushing Records" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" CssClass="grid_wrapper">
        <telerik:RadDropDownList ID="RadDropDownListCategory" runat="server" AutoPostBack="true" Width="300px">
            <Items>
                <telerik:DropDownListItem Value="GAMERUSH" Text="Rushing Yards (CAREER)" />
            </Items>

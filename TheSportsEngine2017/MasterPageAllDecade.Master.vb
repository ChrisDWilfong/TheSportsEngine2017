Public Class MasterPageAllDecade
    Inherits System.Web.UI.MasterPage

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Session("globalSport") = "AllDecade"
        ...
        ' Page Title and Image Headers...
        'Me.Page.Title = clsStateChampions.GetPageHeader(Session("globalState"), " High School Basketball State Championships")

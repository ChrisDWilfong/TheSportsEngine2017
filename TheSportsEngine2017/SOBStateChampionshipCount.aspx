<%@ Page Title="Oklahoma High School Boys Soccer State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageSoccer.Master" CodeBehind="SOBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.SOBStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Soccer_StateChampions WHERE strState = @state AND strSportGenderKey = 'SoccerBoys' AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

<%@ Page Title="Oklahoma High School Basketball Boys State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.BKBStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Basketball_StateChampionsCOUNT WHERE strSportGenderKey = 'BasketballBoys' AND strState = @state AND intChampionships >=3 ORDER BY intChampionships DESC, strTeam">
        <SelectParameters>

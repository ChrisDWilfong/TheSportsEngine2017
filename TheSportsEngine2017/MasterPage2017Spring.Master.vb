...
Public Class MasterPage2017Spring
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '''''Me.Page.Title = clsStateChampions.GetPageHeader(Session("globalState"), " High School Football State Championships")
        ...
        hlHeader1.NavigateUrl = ConfigurationManager.AppSettings("HomePage")
        hlHeader2.NavigateUrl = ConfigurationManager.AppSettings("HomePage")

<%@ Page Title="Oklahoma High School Football State Championship Coaches" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBStateChampionshipCoaches.aspx.vb" Inherits="TheSportsEngine2017.FBStateChampionshipCoaches" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT strCoach, COUNT(strCoach) AS intChampionships, CAST(COUNT(strCoach) AS varchar(10)) + ' : ' + strCoach AS strDisplay, RANK() OVER (ORDER BY COUNT(strCoach) DESC) AS intRank FROM IWATGview_Football_StateChampions WHERE (strState = @state) AND intYear >= 1944 GROUP BY strCoach ORDER BY intChampionships DESC, strCoach">
        <SelectParameters>

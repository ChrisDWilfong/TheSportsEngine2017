Public Class JustFootball
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.UserHostAddress.ToString = "119.27.178.206" Then
        ...
        Try
            clsLog.LogEvent("JustFootball", Me.Page.AppRelativeVirtualPath.ToString, "", "", Request.UserHostAddress, Session("globalState"), Session("globalUser"), Request.UserAgent)
        Catch
        End Try

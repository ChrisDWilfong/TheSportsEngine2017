Public Class MasterPageSoftballPhoto
    Inherits System.Web.UI.MasterPage

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Session("globalSport") = "Softball"
        ...
        Me.Page.Title = clsStateChampions.GetPageHeader(Session("globalState"), " High School Softball State Championships")

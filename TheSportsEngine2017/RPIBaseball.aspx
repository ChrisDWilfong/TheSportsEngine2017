<%@ Page Title="2018 Oklahoma High School Baseball RPI" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBaseballNOAJAX.Master" CodeBehind="RPIBaseball.aspx.vb" Inherits="TheSportsEngine2017.RPIBaseball" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 strDisplay + ' (' + CAST(SOSRank AS varchar(10)) + ')' AS strDisplayFinalRPI FROM RPI WHERE Class = @class AND Sport = 'Baseball' AND GamesMin = 2018 ORDER BY RPIRank">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 20 strDisplaySOS + ' (' + CAST(RPIRank AS varchar(10)) + ')' AS strDisplayFinalSOS FROM RPI WHERE Class = @class AND Sport = 'Baseball' AND GamesMin = 2018 ORDER BY SOSRank">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="class" DefaultValue="A" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource> 

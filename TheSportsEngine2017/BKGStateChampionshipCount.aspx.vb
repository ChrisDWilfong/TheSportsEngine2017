...
Partial Class BKGStateChampionshipCount
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Else
        '    SqlDataSource1.SelectCommand = "SELECT * FROM IWATGview_GirlsChampionshipGamesWins_ALL WHERE strState = @state ORDER BY intWins DESC, strTeam"
        'End If

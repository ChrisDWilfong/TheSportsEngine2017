...
Public Class FBPlayoffs1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'lblOneColumnHeader.Text = clsStateChampions.GetPageHeader(Session("globalState"), ConfigurationManager.AppSettings("ThisYearOfFootballPlayoffs") & " FOOTBALL PLAYOFF CENTRAL")
        ...
        Try
            clsLog.LogEvent("FOOTBALLPlayoffs", Me.Page.AppRelativeVirtualPath.ToString, "", "", Request.UserHostAddress, Session("globalState"), Session("globalUser"), Request.UserAgent)
        Catch
        End Try
    End Sub

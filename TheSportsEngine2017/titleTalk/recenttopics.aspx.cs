...
namespace aspnetforum
{
    public partial class recenttopics : ForumPage
    {
        ...
        private string GetRssXML()
        {
			...
			DbDataReader dr = Cn.ExecuteReader(@"SELECT TOP 25 ForumTopics.TopicID, ForumTopics.Subject, ForumTopics.LastMessageID, ForumMessages.CreationDate, ForumTopics.RepliesCount
                FROM ForumTopics

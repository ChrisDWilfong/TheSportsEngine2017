...
namespace aspnetforum
{
	...
	public partial class topics : ForumPage
	{
        ...
        public static string DisplayWhoAmI(object whoAmI)
        {
		...
		public static void BindSubforums(DbCommand cmd, Repeater rptSubForumsList, int forumID, int viewerUserId)
		{
			...
			cmd.CommandText =
				string.Format(@"SELECT Forums.ForumID, Forums.Title, Forums.Description, Count(ForumTopics.TopicID) AS Topics, Forums.GroupID, MAX(ForumTopics.LastMessageID) as LatestMessageID, Forums.OrderByNumber, Forums.IconFile, ForumTopics.WhoAmI AS WhoAmI
				...
				GROUP BY Forums.ForumID, Forums.Title, Forums.Description, Forums.GroupID, Forums.OrderByNumber, Forums.IconFile, ForumTopics.WhoAmI

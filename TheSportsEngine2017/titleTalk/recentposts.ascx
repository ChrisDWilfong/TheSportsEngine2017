...
<asp:repeater id="rptMessagesList" runat="server" EnableViewState="False" OnItemDataBound="rptMessagesList_ItemDataBound">
	<HeaderTemplate>
		<table width="100%" cellpadding="19" class="roundedborder postlist">
			<tr>
				<th><h2><%= aspnetforum.Resources.various.RecentPosts %>&nbsp;<a href="recent.aspx?rss=1" runat="server" id="rssLink" enableviewstate="false"><img alt="recent posts - RSS" src="images/rss.png" /></a></h2></th>
			</tr>
			<tbody>
	</HeaderTemplate>
	<ItemTemplate>
		<tr valign="top" <%# Container.ItemType == ListItemType.AlternatingItem ? " class='altItem'" : "" %>>
			<td>
				...
				<br/><br/>
				<%# aspnetforum.Utils.User.DisplayUserInfo(Eval("UserID"), Eval("UserName"), Eval("PostsCount"), Eval("AvatarFileName"), "", Eval("FirstName"), Eval("LastName"), Eval("WhoAmI"))%>
			</td>

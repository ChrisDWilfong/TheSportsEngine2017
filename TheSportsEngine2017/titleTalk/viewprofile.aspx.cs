...
namespace aspnetforum
{
	...
	public partial class viewprofile : ForumPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnDeleteAllPostsAndDisable.Visible = IsAdministrator;
		...
		protected void btnActivateUser_Click(object sender, EventArgs e)
		{
			if (IsAdministrator)
			{
				Utils.User.EnableUser(_userId, true);
		...
		protected void btnDeleteAllPostsAndDisable_Click(object sender, EventArgs e)
		{
			if (IsAdministrator)
			{
				Utils.User.DeleteAllPosts(_userId);

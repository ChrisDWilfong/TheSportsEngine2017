...
namespace aspnetforum.Utils
{
	public static class User
	{
		...
		{
			return DisplayUserInfo(uID, uname, postsCount, avatarFileName, null, null, null, null, null, null);
		}
		...
		{
			return DisplayUserInfo(uID, uname, postsCount, avatarFileName, null, firstName, lastName, null, null, null);
		}
        ...
        public static string DisplayUserInfo(object uID, object uname, object postsCount, object avatarFileName, object currentForumId, object firstName, object lastName, object WhoAmI)
        {
            /// Added 9/30/2017...
            return DisplayUserInfo(uID, uname, postsCount, avatarFileName, null, firstName, lastName, null, null, WhoAmI);
        }
        /// <summary>
        ...
        /// </summary>
        public static string DisplayUserInfo(object uID, object uname, object postsCount, object avatarFileName, object currentForumId, object firstName, object lastName, object useGravatar, object email,  object whoAmI)
		{
			...
			if (Convert.ToInt32(uID) != 0)
			{
                ...
                if (whoAmI != null)
                {
                    output.Append("<div class='mobilehidden' class=\"gray\">" + whoAmI + "</div>");
                }

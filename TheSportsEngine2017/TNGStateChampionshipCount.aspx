<%@ Page Title="Oklahoma High School Girls Tennis State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageTennis.Master" CodeBehind="TNGStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.TNGStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Tennis_StateChampions WHERE strState = @state AND strSportGenderKey = 'TennisGirls' AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

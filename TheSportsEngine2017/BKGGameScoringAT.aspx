<%@ Page Title="Oklahoma High School Girls Basketball Game Scoring" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKGGameScoringAT.aspx.vb" Inherits="TheSportsEngine2017.BKGGameScoringAT" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:description" content="Most points scored in an Oklahoma High School Girls 5-on-5 Basketball game." />
            ...
            <telerik:LayoutRow>
                <Columns>
                    <telerik:LayoutColumn Span="12" HiddenXs="true" HiddenSm ="true" SpanMd="12" SpanLg="12" SpanXl="12">
                        <h3><asp:Label ID="lblOneColumnHeader0" runat="server" Text="OKLAHOMA HIGH SCHOOL 45+ GAME SCORING"></asp:Label><br />
                        <asp:Label ID="lblOneColumnDetail0" runat="server" Text="GIRLS BASKETBALL 5-on-5"></asp:Label></h3>
                    </telerik:LayoutColumn>
                    <telerik:LayoutColumn Span="12" SpanXs="12" SpanSm="12" HiddenMd="true" HiddenLg="true" HiddenXl="true">
                        <h3><asp:Label ID="lblOneColumnHeader" runat="server" Text="OKLAHOMA HIGH SCHOOL 45+ GAME SCORING"></asp:Label><br />
                        <asp:Label ID="lblOneColumnDetail" runat="server" Text="GIRLS BASKETBALL 5-on-5"></asp:Label></h3>
                    </telerik:LayoutColumn>
                </Columns>
            </telerik:LayoutRow>
        </Rows>

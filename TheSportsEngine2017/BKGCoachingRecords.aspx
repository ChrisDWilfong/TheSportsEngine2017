<%@ Page Title="Oklahoma High School GIRLS Basketball Coaching Records" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKGCoachingRecords.aspx.vb" Inherits="TheSportsEngine2017.BKGCoachingRecords" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:description" content="ALL-TIME Oklahoma High School GIRLS Basketball Coaching Wins" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT CAST(intWins AS varchar(10)) + ' - ' + strFirstName + ' ' + strLastName + ' ' + CASE WHEN strActive Is Null THEN '' ELSE strActive END AS strDisplay, intWins FROM tblBasketballCoachingRecords WHERE strSportGenderKey = 'BasketballGirls' AND intWins >= 375 ORDER BY intWins DESC">
    </asp:SqlDataSource>    
</asp:Content>

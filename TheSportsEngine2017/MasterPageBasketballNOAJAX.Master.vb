Public Class MasterPageBasketballNOAJAX
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Page.Title = clsStateChampions.GetPageHeader(Session("globalState"), " High School Basketball State Championships")
        imgHeader1.ImageUrl = clsStateChampions.GetLogoHeader(Session("globalSport"), Session("globalState"), Request.Url.Host.ToUpper, Request.FilePath.ToString)
        imgHeader2.ImageUrl = clsStateChampions.GetLogoHeader(Session("globalSport"), Session("globalState"), Request.Url.Host.ToUpper, Request.FilePath.ToString)

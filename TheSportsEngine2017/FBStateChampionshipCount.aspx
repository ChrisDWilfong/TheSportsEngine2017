<%@ Page Title="Oklahoma High School Football State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.FBStateChampionshipCount" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Football State Championship Count" />
    <meta name="twitter:description" content="ALL-TIME High School Football State Champions (since 1944)" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Football_StateChampions WHERE strState = @state AND intStateChampionshipCount >= 2 AND intYear >= 1944 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

<%@ Page Title="Oklahoma High School Cheerleading State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPage2017.Master" CodeBehind="CHGStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.CHStateChampionshipCount" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:description" content="ALL-TIME High School Cheer State Championship Count (since 1989)" />
    <meta name="twitter:image" content="http://www.iwasatthegame.com/TwitterCards/IWATG_Logo_Cheerleading.png" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Cheerleading_StateChampions WHERE strState = @state AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

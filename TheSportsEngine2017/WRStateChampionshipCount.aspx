<%@ Page Title="Oklahoma High School Boys Track State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageWrestling.Master" CodeBehind="WRStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.WRStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Wrestling_StateChampions WHERE strState = @state AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

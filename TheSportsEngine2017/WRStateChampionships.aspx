<%@ Page Title="Oklahoma Wrestling State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageWrestlingPhoto.Master" CodeBehind="WRStateChampionships.aspx.vb" Inherits="TheSportsEngine2017.WRStateChampionships" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Wrestling State Champions" />
    <meta name="twitter:description" content="ALL-TIME High School Wrestling State Champions (since 1922)" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Wrestling_StateChampions WHERE strState = @state AND intYear = @selectedYear ORDER BY strSportGenderKey DESC, strClass DESC">
        <SelectParameters>

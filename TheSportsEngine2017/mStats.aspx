<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="mStats.aspx.vb" Inherits="TheSportsEngine2017.mStats" %>
              ...
              <div class="rd-navbar-main-top">
                <div class="rd-navbar-main-container container">
                  ...
                  <ul class="rd-navbar-list">
                    <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img src="LOC/site/images/_blank.png" alt="" width="75" height="42"/></a></li>
                    <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img src="LOC/site/images/partners-4-inverse-79x52.png" alt="" width="110" height="72"/></a></li>
                    <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img src="LOC/site/images/partners-3-inverse-79x52.png" alt="" width="79" height="52"/></a></li>
                  </ul>
                ...
                <div class="col-12">
                  ...
                  <article class="heading-component">
                    ...
                    <div class="heading-component-inner">
                      <h5 class="heading-component-title"><%= Session("BootstrapHeader") %>
                      </h5>
                        ...
                        <ul class="list-inline list-inline-xs list-inline-middle">
                          <li>
                            <asp:DropDownList runat="server" ID="CboSport" CssClass="select select-minimal" data-placeholder="Sport" data-dropdown-class="select-minimal-dropdown" style="min-width: 200px" 
                                AutoPostBack="true" OnDataBound="CboSport_DataBound" OnSelectedIndexChanged="CboSport_SelectedIndexChanged" DataTextField="strTextField" DataValueField="strValueField" Visible="true">

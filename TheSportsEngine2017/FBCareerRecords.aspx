	<%@ Page Title="Oklahoma High School Football All-Time Career Records" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBCareerRecords.aspx.vb" Inherits="TheSportsEngine2017.FBCareerRecords" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" CssClass="grid_wrapper">
        <telerik:RadDropDownList ID="RadDropDownListCategory" runat="server" AutoPostBack="true" Width="300px">
            <Items>
                <telerik:DropDownListItem Value="GAMERUSH" Text="Rushing Yards (CAREER) (thru 2019)" />
                <telerik:DropDownListItem Value="GAMEPASS" Text="Passing Yards (CAREER) (thru 2019)" />
                <telerik:DropDownListItem Value="GAMEREC" Text="Receiving Yards (CAREER) (thru 2019)" />

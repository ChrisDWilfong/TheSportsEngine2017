<%@ Page Title="Oklahoma High School Football Playoffs" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBPlayoffStreaks.aspx.vb" Inherits="TheSportsEngine2017.FBPlayoffStreaks" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:description" content="ALL-TIME Oklahoma High School Football Playoff Years Streak (since 1944)" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT Id, strSport, strTeam, intYearStart, intYearEnd, intYears, strStreak, CAST(intYears AS varchar(5)) + ' (' + CAST(intYearEnd AS varchar(5)) + '-' + CAST(intYearStart AS varchar(5)) + ') - ' + strTeam AS strDisplay FROM tblStreak WHERE strSport = 'Football' AND (intYears >= 10) AND strState = @state ORDER BY intYears DESC, strTeam">
        <SelectParameters>

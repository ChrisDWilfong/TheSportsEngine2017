    <%@ Page Title="Oklahoma High School Football Regular Season Points" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBOffenseFull.aspx.vb" Inherits="TheSportsEngine2017.FBOffenseFull" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 100 intPoints, CAST(intPoints as varchar) + ' : ' + School + CASE WHEN strClass Is Null THEN '' ELSE ' (' + strClass + ')' END + ' - ' + CAST(Year as varchar) AS strDisplay FROM IWATGview_FootballYearlyRecords ORDER BY intPoints DESC">
        <SelectParameters>

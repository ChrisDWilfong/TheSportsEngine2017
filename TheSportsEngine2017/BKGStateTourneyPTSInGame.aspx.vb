...
Partial Class BKGStateTourneyPTSInGame
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            If Session("globalUser") = "" Then
                SqlDataSource1.SelectCommand = "SELECT * FROM IWATGview_Girls_PointsScoredInTournamentGameByWTeam_ALL WHERE strState = @state AND intWinner >= 82 ORDER BY intWinner DESC"
            Else
                SqlDataSource1.SelectCommand = "SELECT * FROM IWATGview_Girls_PointsScoredInTournamentGameByWTeam_ALL WHERE strState = @state AND intWinner >= 70 ORDER BY intWinner DESC"
            End If
        End If
        Try

<%@ Page Title="Oklahoma High School Jazz Band State Champions" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPage2017.Master" CodeBehind="NAJazzStateChampionshipsSchool.aspx.vb" Inherits="TheSportsEngine2017.NAJazzStateChampionshipsSchool" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                ...
                <asp:TableCell>
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowPaging="false" >
                        <MasterTableView DataSourceID="SqlDataSource1" TableLayout="Fixed" AllowSorting="false" AllowFilteringByColumn="false" NoMasterRecordsText="Make selection above...">
                            <Columns>
                                <telerik:GridBoundColumn DataField="strDisplaySchool" HeaderAbbr="Team" UniqueName="strDisplaySchool" HeaderText="JAZZ BAND STATE CHAMPIONS" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_NAJazzBand_StateChampions WHERE strState = @state AND strSchool = @selectedSchool ORDER BY intYear DESC">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strSchool FROM IWATGview_NAJazzBand_StateChampions WHERE strState = @state ORDER BY strSchool">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />
        </SelectParameters>    
    </asp:SqlDataSource>    

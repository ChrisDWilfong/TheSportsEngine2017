<%@ Page Title="Oklahoma High School Boys Swimming State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageSwimming.Master" CodeBehind="SWBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.SWBStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Swimming_StateChampions WHERE strState = @state AND strSportGenderKey = 'SwimmingBoys' AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

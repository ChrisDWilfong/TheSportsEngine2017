<%@ Page Title="Oklahoma High School Football All-Time Wins" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootballNOAJAX.Master" CodeBehind="FBWL5Year.aspx.vb" Inherits="TheSportsEngine2017.FBWL5Year" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                                ...
                                <asp:TableRow HorizontalAlign="Center">
                                    <asp:TableCell>
                                        <telerik:RadGrid ID="RadGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" AllowPaging="true" >
                                            <MasterTableView DataSourceID="SqlDataSource1" TableLayout="Fixed" AllowSorting="true" AllowFilteringByColumn="False" NoMasterRecordsText="None found" PageSize="100">
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn DataField="sumWins" HeaderAbbr="W" UniqueName="sumWins" HeaderText="W" AllowFiltering="false" AllowSorting="True" >
                                                        <HeaderStyle Font-Bold="true" Width="15%" HorizontalAlign="Center" />
                                                        <ItemStyle Width="15%" HorizontalAlign="Right"/>
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="sumLosses" HeaderAbbr="L" UniqueName="sumLosses" HeaderText="L" AllowFiltering="false" AllowSorting="True" >
                                                        <HeaderStyle Font-Bold="true" Width="15%" HorizontalAlign="Center" />
                                                        <ItemStyle Width="15%" HorizontalAlign="Right"/>
                                                    </telerik:GridBoundColumn>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_FootballOffense_5YearsWL WHERE lastClass = @cboClass AND strState = @state AND Not lastClass Is Null AND TotalYears >= 5 ORDER BY sumWins DESC, sumLosses, strSchool">
        <SelectParameters>

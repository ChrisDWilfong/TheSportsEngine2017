...
Partial Class BAFStateTourneyWL
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            SqlDataSource1.SelectCommand = "SELECT *, W AS intWins, CAST(W AS varchar) + ' - ' + strTeam + ' (' + CAST(W as varchar) + '-' + CAST(L as varchar) + ')' AS strDisplay FROM IWATGview_BaseballFall_StateTournamentWLRecords ORDER BY W DESC, strTeam"
        End If

<%@ Page Title="Oklahoma High School Boys Gymnastics State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageGymnastics.Master" CodeBehind="GYMBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.GYMBStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Gymnastics_StateChampions WHERE strState = @state AND strSportGenderKey = 'GymnasticsBoys' AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

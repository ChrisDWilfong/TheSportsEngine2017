<%@ Page Title="Oklahoma High School Girls Cross Country State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageTrack.Master" CodeBehind="CCGStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.CCGStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_CrossCountry_StateChampions WHERE strState = @state AND strSportGenderKey = 'CrossCountryGirls' ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

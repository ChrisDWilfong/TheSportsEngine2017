...
Public Class BAMLB
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strDateLast = SqlHelper.ExecuteScalar(SqlHelper.SQLConnectionIWATG, CommandType.Text, "SELECT TOP 1 strDateLast FROM tblBaseballHSMLB WHERE NOT strDateLast Is Null AND intYear = 2018")

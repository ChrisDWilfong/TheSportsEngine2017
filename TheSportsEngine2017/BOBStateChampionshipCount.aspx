<%@ Page Title="Oklahoma High School Boys Bowling State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBowling.Master" CodeBehind="BOBStateChampionshipCount.aspx.vb" Inherits="TheSportsEngine2017.BOBStateChampionshipCount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT strWinner, CAST(intStateChampionshipCount AS varchar) + ' - ' + strWinner + ' (' + CAST(intLastChampionshipYear AS varchar) + ')' AS strDisplay, intStateChampionshipCount FROM IWATGview_Bowling_StateChampions WHERE strState = @state AND strSportGenderKey = 'BowlingBoys' AND intStateChampionshipCount >= 2 ORDER BY intStateChampionshipCount DESC, strWinner">
        <SelectParameters>

<%@ Page Title="Oklahoma High School Football Games" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootballAds.Master" CodeBehind="FBGamesAds.aspx.vb" Inherits="TheSportsEngine2017.FBGamesAds" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" CssClass="grid_wrapper">
        <asp:Table runat="server" ID="tblBKBStateTourneyScores">
            <asp:TableRow>
                <asp:TableCell>
                    <telerik:RadRotator ID="RadRotatorSchoolAds" runat="server" DataSourceID="SqlDataSourceSchoolAds" RenderMode="Lightweight" Width="400" Height="80" 
                        ScrollDuration="1500" ScrollDirection="Left" FrameDuration="2000" ItemHeight="80" ItemWidth="400" >
                        <ItemTemplate>
                            <asp:Hyperlink runat="server" ImageUrl='<%# Eval("adImage") %>' Target="_blank" NavigateUrl='<%# Eval("adNavigateURL") %>' />
                        </ItemTemplate>
                    </telerik:RadRotator>
                </asp:TableCell>
            </asp:TableRow>

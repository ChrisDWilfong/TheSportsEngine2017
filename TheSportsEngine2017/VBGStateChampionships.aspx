<%@ Page Title="Oklahoma High School Volleyball State Championships" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageVolleyballPhoto.Master" CodeBehind="VBGStateChampionships.aspx.vb" Inherits="TheSportsEngine2017.VBGStateChampionships" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Volleyball State Champions " />
    <meta name="twitter:description" content="Oklahoma High School Volleyball State Champions (since 1955)" />
    <meta name="twitter:image" content="http://www.iwasatthegame.com/Images/Volleyball300.gif" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowSorting="True" AutoGenerateColumns="False" 
                        ...
                        <MasterTableView DataSourceID="SqlDataSource1" TableLayout="Fixed" AllowSorting="false" AllowFilteringByColumn="false" DataKeyNames="Id" NoMasterRecordsText="Make selection above..." NoDetailRecordsText="No Articles found...">
                            <DetailTables>
                                <telerik:GridTableView EnableHierarchyExpandAll="true" DataKeyNames="id" DataSourceID="SQLDataSourceDetail" runat="server" AllowFilteringByColumn="false" AllowSorting="false" NoDetailRecordsText="No Articles Found...">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_Volleyball_StateChampions WHERE strState = @state AND intYear = @selectedYear AND strSportGenderKey = 'Volleyball' ORDER BY strSportGenderKey DESC, strClass DESC">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT DISTINCT intYear, CAST(intYear AS varchar) AS strYear FROM IWATGview_Volleyball_StateChampions WHERE strState = @state AND strSportGenderKey = 'Volleyball' ORDER BY intYear DESC">
        <SelectParameters>
            <asp:SessionParameter Name="state" SessionField="globalState" DefaultValue="OK" Type="String" />
        </SelectParameters>    
    </asp:SqlDataSource>    

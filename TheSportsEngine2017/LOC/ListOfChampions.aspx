...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <!-- Site Title-->
    <title>ListOfChampions.com</title>
    ...
    <link rel="stylesheet" href="site/css/bootstrap2.css"/>
                        ...
                        <ul class="list-inline list-inline-xs list-inline-middle">
                          <li>
                            <asp:DropDownList runat="server" ID="CboSport" CssClass="select select-minimal" data-placeholder="Sport" data-dropdown-class="select-minimal-dropdown" style="min-width: 200px" 
                                AutoPostBack="true" OnDataBound="CboSport_DataBound" OnSelectedIndexChanged="CboSport_SelectedIndexChanged" DataTextField="strTextField" DataValueField="strValueField" Visible="false">

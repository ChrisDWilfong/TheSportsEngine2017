<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="standings.aspx.vb" Inherits="TheSportsEngine2017.standings" %>
    ...
    <div class="page">
            ...
            <div class="rd-navbar-main">
              <div class="rd-navbar-main-top">
                <div class="rd-navbar-main-container container">
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="../landing"><img class="brand-logo" src="site/images/LOC/DrPepper.png" alt="" width="195" height="126"/></a>
                  </div>
                  <!-- RD Navbar List-->
                ...
                <div class="rd-navbar-main-container container">
                  <!-- RD Navbar Nav-->
                                    <ul class="rd-navbar-nav">
                                      ...
                                      <li class="rd-nav-item active"><a class="rd-nav-link" href="#">Team</a>
                                                          <ul class="rd-menu rd-navbar-dropdown">
      ...
      <section class="section parallax-container breadcrumbs-wrap" data-parallax-img="site/images/bg-breadcrumbs-1-1920x726.jpg">
        <div class="parallax-content breadcrumbs-custom context-dark">
          <div class="container">
            <div class="rd-navbar-brand"><a class="brand" href="../landing"><img class="brand-logo " src="site/images/LOC/IWATG.Football.comWEB.png" alt="" width="846" height="170"/></a>
            </div>
          </div>
        </div>
      </section>

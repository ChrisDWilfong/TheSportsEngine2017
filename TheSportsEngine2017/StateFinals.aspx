<%@ Page Title="Oklahoma : State Final Appearances" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBillboard.Master" CodeBehind="StateFinals.aspx.vb" Inherits="TheSportsEngine2017.StateFinals" %>
            ...
            <telerik:LayoutRow>
                <Columns>
                    <telerik:LayoutColumn Span="12" HiddenXs="true" HiddenSm ="true" SpanMd="12" SpanLg="12" SpanXl="12">
                        ...
                        <h1><asp:Label ID="lblOneColumnState0" runat="server" Font-Bold="true" Text="" Font-Names="Lalezar" Visible="false"></asp:Label></h1>
                    ...
                    <telerik:LayoutColumn Span="12" SpanXs="12" SpanSm="12" HiddenMd="true" HiddenLg="true" HiddenXl="true">
                        ...
                        <h1><asp:Label ID="lblOneColumnState" runat="server" Font-Bold="true" Text="" Font-Names="Lalezar" Visible="false"></asp:Label></h1>

<%@ Page Title="Oklahoma High School Football Playoffs" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootball.Master" CodeBehind="FBPlayoffsWeek1.aspx.vb" Inherits="TheSportsEngine2017.FBPlayoffs" %>
                        ...
                        <asp:Table runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                                    ...
                                    <asp:HyperLink runat="server" ID="HyperLink0" Text="CLASS 6A-I" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_6AIPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink1" Text="CLASS 6A-II" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_6AIIPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink2" Text="CLASS 5A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_5APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink3" Text="CLASS 4A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_4APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink4" Text="CLASS 3A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_3APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink5" Text="CLASS 2A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_2APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;<br />
                                    <asp:HyperLink runat="server" ID="HyperLink6" Text="CLASS A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink7" Text="CLASS B" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_BPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink8" Text="CLASS C" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_CPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Medium" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow><asp:TableCell ColumnSpan="2">&nbsp;</asp:TableCell></asp:TableRow>
                            <asp:TableRow><asp:TableCell ColumnSpan="2"><h2>2019 PLAYOFFS WEEK 1</h2></asp:TableCell></asp:TableRow>
                        </asp:Table>
                        ...
                        <asp:Table runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                                    ...
                                    <asp:HyperLink runat="server" ID="HyperLink9" Text="CLASS 6A-I" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_6AIPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink10" Text="CLASS 6A-II" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_6AIIPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink11" Text="CLASS 5A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_5APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink12" Text="CLASS 4A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_4APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink13" Text="CLASS 3A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_3APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink14" Text="CLASS 2A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_2APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink15" Text="CLASS A" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_APlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink16" Text="CLASS B" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_BPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>&nbsp;
                                    <asp:HyperLink runat="server" ID="HyperLink17" Text="CLASS C" NavigateUrl="http://www.ossaa.net/docs/2019-20/Football/FB_2019-20_CPlayoffBracket.pdf?id=18" Target="_blank" Font-Size="Small" Font-Names="'Segoe UI', Arial, sans-serif"></asp:HyperLink>
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </telerik:LayoutColumn>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource6AI" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT strDisplay, strSchoolName AS strSchool, strDisplayCaps, strAdSchool, strAdSchoolURL FROM viewFootballScoresPlayoffsWeek1 WHERE (strAt = 'Away' OR strAt = 'A') AND (strDistrict = '6A-1' OR strDistrict = '6A-2') ORDER BY intGame, strSchool">
    </asp:SqlDataSource>    

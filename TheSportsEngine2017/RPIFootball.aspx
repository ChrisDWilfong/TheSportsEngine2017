<%@ Page Title="2018 Oklahoma High School Football RPI" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageFootballNOAJAXRPI.Master" CodeBehind="RPIFootball.aspx.vb" Inherits="TheSportsEngine2017.RPIFootball" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Football RPI Rankings" />
    <meta name="twitter:description" content="NO OPINIONS, FAVORITES or WHO SPONSORS US... JUST ABOUT THE WINS!" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:DropDownList ID="RadDropDownListClass" runat="server" AutoPostBack="True"
                                            ...
                                            <asp:ListItem Text="Class 6A-I" Value="6A-I"></asp:ListItem>
                                            <asp:ListItem Text="Class 6A-II" Value="6A-II"></asp:ListItem>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 32 strDisplay + ' (' + CAST(SOSRank AS varchar(10)) + ')' AS strDisplayFinalRPI FROM RPI WHERE Class = @class AND Sport = 'Football' AND DateEnd = '2019-11-08' ORDER BY RPIRank">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="class" DefaultValue="6A-I" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource>   
    
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 32 strDisplaySOS + ' (' + CAST(RPIRank AS varchar(10)) + ')' AS strDisplayFinalSOS FROM RPI WHERE Class = @class AND Sport = 'Football' AND DateEnd = '2019-11-08' ORDER BY SOSRank">
        <SelectParameters>
            <asp:ControlParameter ControlID="RadDropDownListClass" Name="class" DefaultValue="6A-I" Type="String" />
        </SelectParameters>  
    </asp:SqlDataSource> 

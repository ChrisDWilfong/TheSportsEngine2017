<%@ Page Title="Oklahoma High School Ice Hockey State Champions" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageIceHockey.Master" CodeBehind="ICEStateChampionships.aspx.vb" Inherits="TheSportsEngine2017.ICEStateChampionships" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT * FROM IWATGview_IceHockey_StateChampions WHERE strState = @state AND intYear = @selectedYear ORDER BY strSportGenderKey DESC, strClass">
        <SelectParameters>

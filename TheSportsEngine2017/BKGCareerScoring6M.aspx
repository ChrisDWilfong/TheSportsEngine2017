<%@ Page Title="Oklahoma High School Girls 6-on-6 Basketball" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketball.Master" CodeBehind="BKGCareerScoring6M.aspx.vb" Inherits="TheSportsEngine2017.BKGCareerScoring6M" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT CAST(intPoints AS varchar(10)) + ' - ' + strPlayer + ' (' + strSchool + ' ' + CAST(intGradYear AS varchar(10)) + ') ' + CASE WHEN strNotes IS NULL THEN '' ELSE '<br>' + strNotes END AS strDisplay, * FROM tblBasketballAllTimeScoring WHERE strState = @state AND strGender = 'Girls' AND int5or6 = 6 AND strType = 'CAREER' ORDER BY intPoints DESC">
        <SelectParameters>

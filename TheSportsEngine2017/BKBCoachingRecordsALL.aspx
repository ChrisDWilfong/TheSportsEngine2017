<%@ Page Title="Oklahoma High School Boys Basketball Coaching Records" Language="vb" AutoEventWireup="false" MasterPageFile="MasterPageBasketballPOPUP.Master" CodeBehind="BKBCoachingRecordsALL.aspx.vb" Inherits="TheSportsEngine2017.BKBCoachingRecordsALL" %>
...
<asp:Content ID="Content0" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta name="twitter:title" content="Oklahoma High School Boys Basketball All-Time Coaching Wins" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IWATGConnectionString %>" 
        SelectCommand="SELECT TOP 100 CAST(intWins AS varchar(10)) + ' - ' + strFirstName + ' ' + strLastName + ' ' + ' (' + strLastSchool + ') ' + CASE WHEN strActive Is Null THEN '' ELSE strActive END AS strDisplay, intWins, id FROM tblBasketballCoachingRecords WHERE strSportGenderKey = 'BasketballBoys' ORDER BY intWins DESC">
    </asp:SqlDataSource>    
</asp:Content>
